...
namespace ScapeRoom
{
    ...
    {
        private int imgMAdelanteX = 307;
        private int imgMAdelanteY = 399;
        private int imgMAtrasX = 307;
        private int imgMAtrasY = 399;
        private int imgMIzquierdaX = 307;
        private int imgMIzquierdaY = 399;
        private int imgMderechaX = 307;
        private int imgMderechaY = 399;
        ...
        public Room3()
        {
            ...
            tiempoRestante = new TimeSpan(0, 5, 0); // 4 minutos
        ...
        private void Room3_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
        ...
        private void Room3_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (colisionCajaFuerte)
            {
                ...
                if (imgMiniCF.Visible && e.KeyCode == Keys.Enter)
                {
                    using (Form dialog = new Form())
                    {
                        ...
                        {
                            // Verificar si se ingresaron los dígitos correctos (5088)
                            if (textBox.Text == "5088")
                            {
            ...
            if (colisionPista5)
            {
                ...
                if (imgIconoPortal.Visible && e.KeyCode == Keys.Enter && imgLlave.Visible == true)
                {
                    ...
                    this.Hide();
                    Historia4 Parte4 = new Historia4();
                    Parte4.ShowDialog();
                }
            }
            else
